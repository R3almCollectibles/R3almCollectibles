...
const AdminSidebar = () => {
  ...
  return (
    <div className="fixed left-0 top-0 h-full w-64 bg-gray-950 border-r border-gray-800 z-50">
      <div className="p-8">
      ...
      <div className="absolute bottom-8 left-8 right-8">
        <button className="flex items-center gap-4 text-gray-400 hover:text-red-500 transition">
