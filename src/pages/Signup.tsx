    ...
    <div className="min-h-screen bg-gray-950 flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-400">Join the fractional collectibles revolution</p>
        </div>

        <div className="bg-gray-900 rounded-3xl border border-gray-800 p-8 shadow-2xl">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label className className="block text-sm font-medium text-gray-300 mb-2">Email</label>
